...
(echo PE; echo Lima; echo Lima; echo ZuniGamy; echo Internet; echo emirjorge.com; echo @emirjorge)|openssl req -new -x509 -key key.pem -out cert.pem -days 1095 > /dev/null 2>&1
