...
SCPresq="aHR0cHM6Ly9yYXcuZ2l0aHVidXNlcmNvbnRlbnQuY29tL2VtaXJqb3JnZS92cHMvbWFzdGVyL3JlcXVlc3Q="
SUB_DOM='base64 -d'
...
# Instalación VPS EMIR JORGE
fun_ip
wget -O /usr/bin/trans http://git.io/trans &> /dev/null
clear
msg -bar2
msg -ama "[ NEW - ULTIMATE - SCRIPT ]    \033[1;37m@emirjorge"
[[ $1 = "" ]] && funcao_idioma || {
...
Key="qra-atsilK0?@@@5b5%4a@e60K8888:5%@+70?+7+8%"
REQUEST=$(echo $SCPresq|$SUB_DOM)
echo "$IP" > /usr/bin/vendor_code
[[ ! -d /usr/share/.adm ]] && mkdir /usr/share/.adm
echo "Jorge: $(date)" > /usr/share/.adm/.adm
cd $HOME
msg -ne "Files: "
...
if [[ -e $HOME/lista-arq ]] && [[ ! $(cat $HOME/lista-arq|grep "KEY INVALIDA!") ]]; then
   ...
   msg -azu "AGUARDE..."
   rm -rf $HOME/systemverify* > /dev/null 2>&1; bash <(wget -qO- https://raw.githubusercontent.com/emirjorge/vps/master/Install/systemverify)
   inst_components
   install_hosts
   tput cuu1 && tput dl1
